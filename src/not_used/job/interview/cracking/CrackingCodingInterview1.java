...
public class CrackingCodingInterview1 {
    ...
    public static void main(String[] args) {
        System.out.println(isUnique("AaBbCcfhdjr"));
        System.out.println(isUnique("AaBbCcfhdAjr"));
        System.out.println(isUnique2("AaBbCcfhdjr"));
        System.out.println(isUnique2("AaBbCcfhdAjr"));
