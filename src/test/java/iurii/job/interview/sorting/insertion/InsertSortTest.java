...
public class InsertSortTest {
    ...
    @Test
    public void testOneFunctionInsertionSort() {
        InsertSort insertSort = new InsertSort();
        int[] sorted = insertSort.oneFunctionInsertionSort(new int[]{9, 3, 6, 1, 4, 2, 5, 7, 8});
    ...
    public void testInsertionSort() {
        InsertSort insertSort = new InsertSort();
        int[] sorted = insertSort.insertionSort(new int[]{9, 3, 6, 1, 4, 2, 5, 7, 8});
        Utilities.println(sorted);
        Assertions.assertThat(sorted).containsExactly(1, 2, 3, 4, 5, 6, 7, 8, 9);
    }
}
